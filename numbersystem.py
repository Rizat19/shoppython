    ...
    if len(engiz_set - san_set8) == 0 and san != '':
        ...
        while True:
            ...
            if tandau=='1':
                ...
                while True:
                    san1 = inputs('1Сан енгізіңіз:')
                    engiz_set1 = set(san1)
                    if len(engiz_set1 - san_set8) == 0 and san1 != '':
                        a = n810(san)
                        a1 = n810(san1)
                        a3 = add(a, a1)
                        n108(a3)
        ...
        while True:
            ...
            if tandau=='1':
                ...
                while True:
                    ...
                    san1 = inputs('1Сан енгізіңіз:')
                    engiz_set1= set(san1)
                    if len(engiz_set1 - byn_set) == 0 and san1 != '':
                        a = n210(san)
                        a1=n210(san1)
                        a3=add(a,a1)
                        n102(a3)
        ...
        while True:
            ...
            if tandau == '1':
                ...
                while True:
                    san1 = inputs('1Сан енгізіңіз:')
                    engiz_set1= set(san1)
                    if len(engiz_set1 - on_set) == 0 and san1 != '':
                        print(add(san,san1))
                        break
            elif tandau=='5':
                while True:
        ...
        while True:
            ...
            if tandau == '1':
                ...
                while True:
                    ...
                    engiz_set1= set(san1)
                    e = list(san1)
                    if len(engiz_set1 - hex_set) == 0 and san1 != '' and e[0]=='0' and e[1]=='x':
                        a = n1610(san)
                        a1 = n1610(san1)
                        a3 = add(a, a1)
                        n1016(a3)
...
def multiply(san,san1):
    i = int(san)
    i2 = int(san1)
    return i * i2

def division(san,san1):
    i = int(san)
    i2 = int(san1)
    return i / i2
